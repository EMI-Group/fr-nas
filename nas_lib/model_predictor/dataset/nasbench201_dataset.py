...
from nas_lib.model_predictor.search_space.nasbench201_search_space import OPS
...
class NasBench201Dataset(Dataset):
    ...
    def __init__(self, arch_data_list, use_valid_error=True, key_matrix = "matrix", key_ops = "ops"):
        """
...
class NasBench201MultiTransformDataset(Dataset):
