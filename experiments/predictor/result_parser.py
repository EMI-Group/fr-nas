...
def table(result_dict, algo_names):
    ...
    for algo in algo_names:
        ...
        for sample_size in result_dict.keys():
            ...
            mean = round(mean, 4)
            std = round(std, 4)
            result.append((sample_size, mean,std))
...
def main():
    experiment_path_list = [
        "predictor_compare_#Replace With Date#_darts_400",
        "predictor_compare_#Replace With Date#_darts_300",
        "predictor_compare_#Replace With Date#_darts_200",
        "predictor_compare_#Replace With Date#_darts_150",
        "predictor_compare_#Replace With Date#_darts_100",
        "predictor_compare_#Replace With Date#_darts_50",
    ]
